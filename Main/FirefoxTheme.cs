...
using NebulaSpammer.Properties;
...
class FirefoxMainTabControl : TabControl
{
    ...
    protected override void OnPaint(PaintEventArgs e)
    {
        ...
        for (int i = 0; i <= TabPages.Count - 1; i++)
        {
            ...
            {
                G.DrawImage(Resources._16, new Rectangle(TabRect.X + 19, TabRect.Y + ((TabRect.Height / 2) - 10), 22, 22));
            }
            else if (i == 15)
            {
                G.DrawImage(Resources._17, new Rectangle(TabRect.X + 19, TabRect.Y + ((TabRect.Height / 2) - 10), 22, 22));
            }
        }
